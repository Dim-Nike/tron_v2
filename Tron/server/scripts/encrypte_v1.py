...
# msg_ERSR = msg_user_on_ESRS(msg_user, ESRS, f_key)
# msg_img = msg_ERSR_on_img(func_img=img_pxl, msg_ersr=msg_ERSR, s_key=s_key)
# msg_ersr_v2 = msg_img_on_ESRS_number(msg_img=msg_img, esrs_number=ERSR_number)
